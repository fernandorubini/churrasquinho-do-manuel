...
import com.example.grupochurrasquinhodomanuel.features.employees.presentation.EmployeeViewModel
...
val appModule = module {
    ...
    single<AppDatabase> {
        Room.databaseBuilder(
            ...
            // ⚠️ NADA de .addTypeConverter(Converters()) aqui
            .fallbackToDestructiveMigration()
            .build()
    }

    // --- DAOs (tipos explícitos ajudam a inferência do Koin) ---
    ...
    single { EmployeeRepository(employeeDao = get()) }
